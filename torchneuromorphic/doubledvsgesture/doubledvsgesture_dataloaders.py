...
#
# Creation Date : Fri 04 Sep 2020 10:05:17 PM PST
# Last Modified : Fri 04 Sep 2020 01:39:06 PM PDT
#
# Copyright : (c)
...
from ..dvs_gestures.dvsgestures_dataloaders import DVSGestureDataset, sample, create_datasets
...
class DoubleDVSGestureDataset(NeuromorphicDataset):
    ...
    def __init__(
        ...
        super(DoubleDVSGestureDataset, self).__init__(root = None,
                                            transform=transform,
                                            target_transform=target_transform )
       
        self.data_train = DVSGestureDataset( root,
                      train=True,
                      transform=transform,
                      target_transform=target_transform,
